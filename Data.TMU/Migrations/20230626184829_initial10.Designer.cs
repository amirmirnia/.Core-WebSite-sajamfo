...
namespace Data.TMU.Migrations
{
    ...
    [Migration("20230626184829_initial10")]
            ...
            modelBuilder.Entity("Data.TMU.Model.msc.MscUser", b =>
                {
                    ...
                    b.HasOne("Data.TMU.Model.msc.MscPercent", "MscPercent")
                        .WithMany()
                        .HasForeignKey("MscPercentId");

                    b.Navigation("Msc");

                    b.Navigation("MscPercent");
                });
